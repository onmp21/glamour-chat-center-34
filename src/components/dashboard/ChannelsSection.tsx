    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className={cn(
          ...
          isDarkMode ? "hover:bg-zinc-700 text-zinc-400" : "hover:bg-gray-100 text-gray-600"
        )}>
          <Settings size={20} />
        </button>
      </div>
        ...
        {sortedChannels.map(channel => {
          ...
          return (
            <div
              ...
              className={cn(
                "relative p-6 rounded-xl border cursor-pointer transition-all duration-200 hover:shadow-lg group",
                isDarkMode 
            ...
            >
              ...
              <button
                ...
                className={cn(
                  "absolute bottom-3 right-3 opacity-0 group-hover:opacity-100 transition-opacity p-1 rounded",
              ...
              >
                ...
                >
                  <path 
                    fill="currentColor" 
                    d="M6 0L7.5 3.5L11 2L9.5 5.5L11 7L7.5 8.5L6 12L4.5 8.5L1 7L2.5 5.5L1 2L4.5 3.5L6 0Z"
                  />
                </svg>
              </button>
            </div>
