      ...
      <div className="p-4 space-y-4">
        <div className="text-center">
          <span className={cn(
            ...
            isDarkMode ? "bg-zinc-800 text-zinc-400" : "bg-gray-200 text-gray-600"
          )}>
        ...
        <div className="flex justify-start">
          <div className={cn(
            ...
            isDarkMode ? "bg-zinc-800 text-zinc-100 border border-zinc-700" : "bg-white text-gray-900 border border-gray-100"
          )}>
            <span className="text-sm">Gostaria de saber sobre os produtos em promoção</span>
            <div className={cn("text-xs mt-1", isDarkMode ? "text-zinc-400" : "text-gray-500")}>10:30</div>
          </div>
        </div>
        ...
        <div className="flex justify-start">
          <div className={cn(
            ...
            <div className={cn("text-xs mt-1", isDarkMode ? "text-zinc-400" : "text-gray-500")}>10:35</div>
          </div>
        </div>
      </div>
    </div>
