...
export const MobileChatView: React.FC<MobileChatViewProps> = ({
  ...
  return (
    // Add padding-bottom to account for the MobileNavigation height (approx. 60-70px). pb-20 provides 80px.
    <div className={cn("flex flex-col h-full w-full pb-20", isDarkMode ? "bg-zinc-950" : "bg-white")}>
      {/* Header */}
      <div className={cn(
        "flex items-center p-3 border-b sticky top-0 z-10", // Header remains sticky
      ...
      {/* Input Area - Now sits above the padded space */}
