...
export const ChatInterface: React.FC<ChatInterfaceProps> = ({ isDarkMode, activeChannel }) => {
  const { user } = useAuth();
  const {
    getTabConversations,
    activeConversation,
    ...
    <div className={cn(
      ...
      <div className="grid grid-cols-12 gap-4 h-[calc(100vh-140px)]">
        ...
        <Card className={cn(
          ...
          <CardContent className="h-[calc(100vh-320px)] flex flex-col">
            {activeConversation ? (
              <>
                <div className={cn(
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Button 
                    ...
                    className={cn(
                      "w-full",
                      isDarkMode ? "border-gray-600 text-gray-300 hover:bg-gray-700" : "border-gray-300"
                    )}
                  >
